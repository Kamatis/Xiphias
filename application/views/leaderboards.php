...
<!--        <a name="showall" href="#showall">Show all</a>-->
    ...
    <div class="col-sm-12" style="margin-top: 35px;">
      <div class="" style="margin-left: 100px; margin-right: 100px;">
        <table id="rank-table" data-toggle="table" data-url="http://127.0.0.1/xiphias/index.php/pages/getRankings/Academic" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200, 500]" data-search="true" data-show-refresh="true">
          <thead>
            <tr>
